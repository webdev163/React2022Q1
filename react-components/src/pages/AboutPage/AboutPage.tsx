    ...
    return (
      <div className={styles.wrapper} data-testid="about-page">
        ...
        <p>
          ...
          Guardian Weekly, The Guardian is part of the Guardian Media Group, owned by the Scott
          Trust. The trust was created in 1936 to secure the financial and editorial independence of
        </p>
        <p>
          The Guardian in perpetuity and to safeguard the journalistic freedom and liberal values of
        </p>
        <p>
          The Guardian free from commercial or political interference. The trust was converted into
          a limited company in 2008, with a constitution written so as to maintain for The Guardian
